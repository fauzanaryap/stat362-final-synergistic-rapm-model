...
Note: This project is written exclusively in Jupyter notebooks.

In order to replicate my model, you will need to go through the Jupyter Notebooks in the \src folder in this order:

0. HIGHLY RECOMMEND SETTING UP A .VENV | Run the pyproject.toml in Poetry to install all libraries
